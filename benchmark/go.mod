...
replace (
	github.com/dobyte/due/locate/redis/v2 => ../locate/redis
	github.com/dobyte/due/network/kcp/v2 => ../network/kcp
	github.com/dobyte/due/network/quic/v2 => ../network/quic
	github.com/dobyte/due/network/tcp/v2 => ../network/tcp
	github.com/dobyte/due/network/ws/v2 => ../network/ws
	github.com/dobyte/due/registry/nacos/v2 => ../registry/nacos
