...
const (
	...
	zapBufferSizeKey        = "config.log.zap.buffer"
	zapAsyncOutputCallerKey = "config.log.zap.outputCaller"
)
...
func defaultOptions() *options {
	...
	opts.bufferSize = config.Get(zapBufferSizeKey, defaultBufferSize).Int()
	opts.asyncOutputCaller = config.Get(zapAsyncOutputCallerKey, defaultAsyncOutputCaller).Bool()
